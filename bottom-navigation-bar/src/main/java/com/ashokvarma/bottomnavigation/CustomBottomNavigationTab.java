 ...
 * @since 19 Mar 2016
 */
class CustomBottomNavigationTab extends BottomNavigationTab {

    public CustomBottomNavigationTab(Context context) {
        super(context);
    }

    public CustomBottomNavigationTab(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CustomBottomNavigationTab(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public CustomBottomNavigationTab(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
