...
//            viewpagerBanner.setOnInfiniteCyclePageTransformListener(...);
    ...
    public void createSelector() {
        ...
        switch (Constant.SOURCE_TYPE) {
            ...
            case Constant.SOURCE_TYPE_5:
                switch (tab) {
                    case Constant.TAB_1:
                        selectors.add(new SelectorModel(getString(R.string.txt_type0), Constant.SOURCE_TYPE_5, Constant.CATEGORY_25, null));
                        selectors.add(new SelectorModel(Constant.CATEGORY_29, Constant.SOURCE_TYPE_5, Constant.CATEGORY_29, null));
                        selectors.add(new SelectorModel(Constant.TYPE_12, Constant.SOURCE_TYPE_5, Constant.CATEGORY_25, Constant.TYPE_12));
                        selectors.add(new SelectorModel(Constant.TYPE_13, Constant.SOURCE_TYPE_5, Constant.CATEGORY_25, Constant.TYPE_13));
                        selectors.add(new SelectorModel(Constant.TYPE_14, Constant.SOURCE_TYPE_5, Constant.CATEGORY_25, Constant.TYPE_14));
                        selectors.add(new SelectorModel(Constant.TYPE_15, Constant.SOURCE_TYPE_5, Constant.CATEGORY_25, Constant.TYPE_15));
                        selectors.add(new SelectorModel(Constant.TYPE_16, Constant.SOURCE_TYPE_5, Constant.CATEGORY_25, Constant.TYPE_16));
                        selectors.add(new SelectorModel(Constant.TYPE_17, Constant.SOURCE_TYPE_5, Constant.CATEGORY_25, Constant.TYPE_17));
                        selectors.add(new SelectorModel(Constant.TYPE_18, Constant.SOURCE_TYPE_5, Constant.CATEGORY_25, Constant.TYPE_18));
                        selectors.add(new SelectorModel(Constant.TYPE_19, Constant.SOURCE_TYPE_5, Constant.CATEGORY_25, Constant.TYPE_19));
                        sourceType = Constant.SOURCE_TYPE_5;
                        category = Constant.CATEGORY_25;
                        selectors.get(0).setSelected(true);
                        break;
                    case Constant.TAB_2:
                        selectors.add(new SelectorModel(getString(R.string.txt_type0), Constant.SOURCE_TYPE_5, Constant.CATEGORY_26, null));
                        selectors.add(new SelectorModel(Constant.TYPE_29, Constant.SOURCE_TYPE_5, Constant.CATEGORY_26, Constant.TYPE_29));
                        selectors.add(new SelectorModel(Constant.TYPE_30, Constant.SOURCE_TYPE_5, Constant.CATEGORY_26, Constant.TYPE_30));
                        selectors.add(new SelectorModel(Constant.TYPE_31, Constant.SOURCE_TYPE_5, Constant.CATEGORY_26, Constant.TYPE_31));
                        selectors.add(new SelectorModel(Constant.TYPE_32, Constant.SOURCE_TYPE_5, Constant.CATEGORY_26, Constant.TYPE_32));
                        selectors.add(new SelectorModel(Constant.TYPE_33, Constant.SOURCE_TYPE_5, Constant.CATEGORY_26, Constant.TYPE_33));
                        selectors.add(new SelectorModel(Constant.TYPE_34, Constant.SOURCE_TYPE_5, Constant.CATEGORY_26, Constant.TYPE_34));
                        selectors.add(new SelectorModel(Constant.TYPE_35, Constant.SOURCE_TYPE_5, Constant.CATEGORY_26, Constant.TYPE_35));
                        sourceType = Constant.SOURCE_TYPE_5;
                        category = Constant.CATEGORY_26;
                        selectors.get(0).setSelected(true);
                        break;
                    case Constant.TAB_3:
    ...
    public void getList(String sourceType, String category, String type, String start, String limit, boolean flag_dialog) {
        LoggerHelper.info("SourceTypeFragment", sourceType + "+" + category + "+" + type + "+" + start + " + " + limit);
